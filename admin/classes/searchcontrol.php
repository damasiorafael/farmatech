...
class SearchControl {
	...
	{		
		$html = '<img style="visibility: hidden;" id = "'.$this->getDelButtonId($fName, $recId).'" ctrlId="'.$recId.'" fName="'.$fName.'" class="searchPanelButton" src="images/search/closeRed.gif" alt="'."Elimina o controle".'">';
		return $html;
	}
