...
//		make the resulting query
	...
	function createPerPage()
	{
		...
		{
			$rpp.= "Grupos por página".":&nbsp;<select onChange=\"javascript: document.location='".htmlspecialchars(rawurlencode($this->shortTableName))."_report.php?pagesize='+this.options[this.selectedIndex].value;\">";
