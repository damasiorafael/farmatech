...
$arr = array();
$arr['fName'] = "cep";
$arr['viewFormat'] = ViewFormat("cep", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "telefone";
...
//cep - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"cep", ""),"","",MODE_VIEW);
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='area_restrita_users_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='area_restrita_users_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "area_restrita_users_view.htm";
