...
$arr = array();
$arr['fName'] = "titulo";
$arr['viewFormat'] = ViewFormat("titulo", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "img_destaque";
$arr['viewFormat'] = ViewFormat("img_destaque", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "img_interna";
$arr['viewFormat'] = ViewFormat("img_interna", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "conteudo";
$arr['viewFormat'] = ViewFormat("conteudo", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "destaque_home";
$arr['viewFormat'] = ViewFormat("destaque_home", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ativo";
...
//titulo - 
	...
	$xt->assign("titulo_value",$value);
	if(!$pageObject->isAppearOnTabs("titulo"))
		$xt->assign("titulo_fieldblock",true);
	else
		$xt->assign("titulo_tabfieldblock",true);
////////////////////////////////////////////
//img_destaque - File-based Image
	...
	$xt->assign("img_destaque_value",$value);
	if(!$pageObject->isAppearOnTabs("img_destaque"))
		$xt->assign("img_destaque_fieldblock",true);
	else
		$xt->assign("img_destaque_tabfieldblock",true);
////////////////////////////////////////////
//img_interna - File-based Image
	...
	$xt->assign("img_interna_value",$value);
	if(!$pageObject->isAppearOnTabs("img_interna"))
		$xt->assign("img_interna_fieldblock",true);
	else
		$xt->assign("img_interna_tabfieldblock",true);
////////////////////////////////////////////
//conteudo - 
	
	$value="";
	$value = ProcessLargeText(GetData($data,"conteudo", ""),"","",MODE_VIEW);
	$xt->assign("conteudo_value",$value);
	if(!$pageObject->isAppearOnTabs("conteudo"))
		$xt->assign("conteudo_fieldblock",true);
	else
		$xt->assign("conteudo_tabfieldblock",true);
////////////////////////////////////////////
//destaque_home - Checkbox
	
	$value="";
	$value = GetData($data,"destaque_home", "Checkbox");
	$xt->assign("destaque_home_value",$value);
	if(!$pageObject->isAppearOnTabs("destaque_home"))
		$xt->assign("destaque_home_fieldblock",true);
	else
		$xt->assign("destaque_home_tabfieldblock",true);
////////////////////////////////////////////
//ativo - Checkbox
	
	$value="";
	$value = GetData($data,"ativo", "Checkbox");
	$xt->assign("ativo_value",$value);
...
//data - Short Date
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"data", "Short Date"),"","",MODE_VIEW);
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='servicos_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='servicos_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "servicos_view.htm";
