...
$templatefile = ($inlineedit == EDIT_INLINE) ? "empresa_inline_edit.htm" : "empresa_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: empresa_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: empresa_list.php?a=return");
		exit();
	}
	else
		$data = array();
