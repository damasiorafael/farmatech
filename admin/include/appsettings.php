...
$tableCaptions["Portuguese(Brazil)"]["banner_home"] = "Banner Home";
...
$tableCaptions["Portuguese(Brazil)"]["servicos"] = "Servicos";
$tableCaptions["Portuguese(Brazil)"]["empresa"] = "Empresa";
$tableCaptions["Portuguese(Brazil)"]["laboratorio"] = "Laboratorio";
$tableCaptions["Portuguese(Brazil)"]["orcamento"] = "Orcamento";
$tableCaptions["Portuguese(Brazil)"]["contato"] = "Contato";
$tableCaptions["Portuguese(Brazil)"]["area_restrita_users"] = "Area-restrita-users";
...
$menuTablesArr = array();
$menuTablesArr[] = array("shortTName"=>"empresa","dataSourceTName"=>"empresa","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"laboratorio","dataSourceTName"=>"laboratorio","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"servicos","dataSourceTName"=>"servicos","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"contato","dataSourceTName"=>"contato","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"orcamento","dataSourceTName"=>"orcamento","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"area_restrita_users","dataSourceTName"=>"area-restrita-users","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"area_restrita","dataSourceTName"=>"area-restrita","nType"=>0);
