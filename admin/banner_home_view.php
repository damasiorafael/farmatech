...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "titulo_banner";
$arr['viewFormat'] = ViewFormat("titulo_banner", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "imagem";
$arr['viewFormat'] = ViewFormat("imagem", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ativo";
...
//titulo_banner - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"titulo_banner", ""),"","",MODE_VIEW);
	$xt->assign("titulo_banner_value",$value);
	if(!$pageObject->isAppearOnTabs("titulo_banner"))
		$xt->assign("titulo_banner_fieldblock",true);
	else
		$xt->assign("titulo_banner_tabfieldblock",true);
////////////////////////////////////////////
//imagem - File-based Image
	...
	$xt->assign("imagem_value",$value);
	if(!$pageObject->isAppearOnTabs("imagem"))
		$xt->assign("imagem_fieldblock",true);
	else
		$xt->assign("imagem_tabfieldblock",true);
////////////////////////////////////////////
//ativo - Checkbox
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='banner_home_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='banner_home_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "banner_home_view.htm";
