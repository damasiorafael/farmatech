...
include("include/laboratorio_variables.php");
...
$arr = array();
$arr['fName'] = "video";
$arr['viewFormat'] = ViewFormat("video", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "foto";
$arr['viewFormat'] = ViewFormat("foto", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ativo";
...
//video - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"video", ""),"","",MODE_VIEW);
	$xt->assign("video_value",$value);
	if(!$pageObject->isAppearOnTabs("video"))
		$xt->assign("video_fieldblock",true);
	else
		$xt->assign("video_tabfieldblock",true);
////////////////////////////////////////////
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='laboratorio_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='laboratorio_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "laboratorio_view.htm";
