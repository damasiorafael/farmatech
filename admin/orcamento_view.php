...
$arr = array();
$arr['fName'] = "endereco";
$arr['viewFormat'] = ViewFormat("endereco", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cidade";
$arr['viewFormat'] = ViewFormat("cidade", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "estado";
$arr['viewFormat'] = ViewFormat("estado", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "telefone";
$arr['viewFormat'] = ViewFormat("telefone", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "receita";
$arr['viewFormat'] = ViewFormat("receita", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "mensagem";
$arr['viewFormat'] = ViewFormat("mensagem", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "respondido";
$arr['viewFormat'] = ViewFormat("respondido", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "excluir";
...
//endereco - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"endereco", ""),"","",MODE_VIEW);
...
//cidade - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"cidade", ""),"","",MODE_VIEW);
...
//estado - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"estado", ""),"","",MODE_VIEW);
	$xt->assign("estado_value",$value);
...
//telefone - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"telefone", ""),"","",MODE_VIEW);
...
////////////////////////////////////////////
//receita - Document Download
	
	$value="";
	$value = GetData($data,"receita", "Document Download");
	$xt->assign("receita_value",$value);
	if(!$pageObject->isAppearOnTabs("receita"))
		$xt->assign("receita_fieldblock",true);
	else
		$xt->assign("receita_tabfieldblock",true);
////////////////////////////////////////////
//mensagem - 
	
	$value="";
	$value = ProcessLargeText(GetData($data,"mensagem", ""),"","",MODE_VIEW);
	$xt->assign("mensagem_value",$value);
	if(!$pageObject->isAppearOnTabs("mensagem"))
		$xt->assign("mensagem_fieldblock",true);
	else
		$xt->assign("mensagem_tabfieldblock",true);
////////////////////////////////////////////
//respondido - Checkbox
	
	$value="";
	$value = GetData($data,"respondido", "Checkbox");
	$xt->assign("respondido_value",$value);
	if(!$pageObject->isAppearOnTabs("respondido"))
		$xt->assign("respondido_fieldblock",true);
	else
		$xt->assign("respondido_tabfieldblock",true);
////////////////////////////////////////////
//excluir - Checkbox
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='orcamento_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='orcamento_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "orcamento_view.htm";
