...
$arr = array();
$arr['fName'] = "assunto";
$arr['viewFormat'] = ViewFormat("assunto", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "mensagem";
...
//assunto - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"assunto", ""),"","",MODE_VIEW);
	$xt->assign("assunto_value",$value);
	if(!$pageObject->isAppearOnTabs("assunto"))
		$xt->assign("assunto_fieldblock",true);
	else
		$xt->assign("assunto_tabfieldblock",true);
////////////////////////////////////////////
//mensagem - 
...
//Begin show Next Prev button
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","id=\"nextButton".$id."\" onclick=\"window.location.href='contato_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","id=\"prevButton".$id."\" onclick=\"window.location.href='contato_view.php?".$prevlink."'\"");
	}
    else 
