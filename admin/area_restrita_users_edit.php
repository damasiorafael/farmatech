...
$templatefile = ($inlineedit == EDIT_INLINE) ? "area_restrita_users_inline_edit.htm" : "area_restrita_users_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: area_restrita_users_".$pageObject->getPageType().".php?".$keyGetQ);
...
/////////////////////////////////////////////////////////////
$query = $queryData_area_restrita_users->Copy();
...
if(!$data)
{
	...
	{
		header("Location: area_restrita_users_list.php?a=return");
		exit();
	}
	else
		$data = array();
