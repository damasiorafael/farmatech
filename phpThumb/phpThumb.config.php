...
$PHPTHUMB_CONFIG['error_image_width']           = 275;      // default width for error images
$PHPTHUMB_CONFIG['error_image_height']          = 275;      // default height for error images
$PHPTHUMB_CONFIG['error_message_image_default'] = 'sem-imagem.jpg';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
